...
public interface WdMethods {
		...
		/**
		 * This method will click if the radio or checkbox is not selected and takes the snap
		 * @param ele   - The Webelement (button/link/element) to be clicked
		 * @author raghu - student
		 */
		
		public void select(WebElement ele);
		/**
		 * This method will click if the radio or checkbox is selected and takes the snap
		 * @param ele   - The Webelement (button/link/element) to be clicked
		 * @author raghu - student
		 */
		...
		/**
		 * This method will clear the element and take snap
		 * @param ele   - The Webelement (button/link/element) to be clicked
		 * @author Babu - TestLeaf
		 */
		 ...
		 * @param ele   - The Webelement (button/link/element) in which text to be clear
		 * @author Raghu - Student
		 */
		...
		/**
		 * This method will switch to the specific frame
		 * @param id   - The ID (frame) to be switched
		 * @author Raghu - Student
		 */
		public void switchToFrameUsingID(String id);
		/**
		 * This method will switch to the specific frame
		 * @param name   - The Name (frame) to be switched
		 * @author Raghu - Student
		 */
		...
		/**
		 * This method will not take the snapshot of the browser
		 * @author Babu - TestLeaf
		 */
		...
		/**
		 * This method will store the text
		 * @author Babu - TestLeaf
		 * @return 
		 */
